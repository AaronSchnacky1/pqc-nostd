// Script to create complete kat.rs file
// Run: cargo test --features "ml-kem,ml-dsa,fips_140_3" create_complete_kat_file -- --nocapture > src/kat_updated.rs 2>&1
